...
SECC_CERTCHAIN_PATH = os.path.join(BASE_DIR, 'common', 'PKI', 'SECC', 'cpoCertChain.p12')
SECC_PRIVATEKEY_PATH = os.path.join(BASE_DIR, 'common', 'PKI', 'SECC', 'secc.key')
SECC_CERTCHAIN_PEM_PATH = os.path.join(BASE_DIR, 'common', 'PKI', 'SECC', 'cpoCertChain.pem')
